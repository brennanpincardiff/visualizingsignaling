...
paul.drawMoleculeJSONformat=function(strategy)
{
 // molecule is the JSON object that describes the parts of the protein. It encodes domains, start, end, info and color
 
    var molecule=strategy.molecule;
 ...
 //       {"Name":"Repeat", "start":145, "end": 187, "Info":"TNFR-Cys 4", "color":"black"}];
    ...
    // It's good practice to generate an svg container that is as large as we need.
        var svgContainer = d3.select(place).append("svg")
                                   .attr("width", 300)
                                   .attr("height", 500);
